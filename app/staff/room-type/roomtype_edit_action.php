...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if(isset($_FILES["fileToUpload"]) &&  $_FILES["fileToUpload"]["name"] == ""){
        $sql = "UPDATE roomtype SET name= '$name', description ='$description', price = '$price', 
            capacity = '$capacity', room_imgpath = '$uploadfileName' WHERE typeID = $id  AND hotelID = ". $_SESSION["hotelID"];
